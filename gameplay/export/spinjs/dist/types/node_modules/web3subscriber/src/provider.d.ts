...
export declare abstract class DelphinusProvider<T extends AbstractProvider> {
    ...
    subscribeEvent<T>(eventName: string, cb: (event: T) => unknown): Promise<T_1>;
...
export declare class DelphinusBrowserConnector extends DelphinusProvider<BrowserProvider> {
    constructor();
...
export declare class DelphinusReadOnlyConnector extends DelphinusProvider<DelphinusBaseProvider> {
    constructor(providerUrl: string);
}
export declare class DelphinusWalletConnector extends DelphinusSigner<Wallet> {
